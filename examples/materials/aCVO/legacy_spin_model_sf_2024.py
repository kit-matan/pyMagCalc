# ===================================================================
# LEGACY -- REFERENCE ONLY. DO NOT BUILD ON THIS.
#
# Provenance: rescued 2026-08-12 from ~/OneDriveMU_20250225_MacBook, a Feb-2025
# machine backup of this tree (HEAD 2a29d23, 2024-03-13) that was deleted after
# verifying its HEAD was an ancestor of master. This file was UNTRACKED there and
# existed nowhere else, so it would have been lost.
#
# It is the 2024 ancestor of `spin_model.py` in this directory, which supersedes
# it (519 lines vs 231: adds applied-field classical minimization, a theta cache
# and logging). Kept because it is not fully subsumed -- it carries a `rot_mat`
# helper that `spin_model.py` does not, plus ~115 other non-comment lines that
# differ. Tracked here rather than in archive/ because pyMagCalc/archive/ is
# gitignored and the workspace root is not a git repository, so there was nowhere
# else it could be version-controlled at all.
#
# This is the hand-written-spin-model style, superseded by declarative YAML
# configs (config_acvo.yaml next to it). See CLAUDE.md.
# ===================================================================
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
